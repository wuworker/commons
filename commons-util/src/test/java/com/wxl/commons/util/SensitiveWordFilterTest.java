...
public class SensitiveWordFilterTest {
    ...
    public void test1() throws IOException {
        ...
        List<String> list = RandomUtils.randomObject(random, 5000,
                (r) -> RandomUtils.randomChinese(r, 2, 5));

        try (BufferedWriter out = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream("src/test/resources/sensitiveWord.txt")))) {
    ...
    private static List<String> readWords() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
                SensitiveWordFilterTest.class.getClassLoader().getResourceAsStream("sensitiveWord.txt")))) {
            String line;
